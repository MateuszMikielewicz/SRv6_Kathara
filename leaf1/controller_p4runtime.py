...
#sdn_controller
controller.table_add('routing_v6_table','set_next_hop', ['2001:c:1::/48'], ['00:cc:00:00:00:00'])
#node_manager_ip_leaf1
controller.table_add('routing_v6_table','set_next_hop', ['3:101:c::1/48'], ['00:aa:00:00:cc:01'])
#node_manager_ip_leaf2
controller.table_add('routing_v6_table','set_next_hop', ['3:102:c::1/48'], ['00:bb:00:00:00:01']) #one sdn interface
...
#sdn_controller
controller.table_add('l2_exact_table','set_egress_port', ['00:cc:00:00:00:00'], ['7'])
#node_manager_ip
controller.table_add('l2_exact_table','set_egress_port', ['00:aa:00:00:cc:01'], ['8'])
...
controller.table_add('l2_ternary_table','set_multicast_group', ['33:33:00:00:00s:00&&&0xffff00000000'], ['255', '10'])
controller.table_add('l2_ternary_table','set_multicast_group', ['ff:ff:ff:ff:ff:ff&&&0xffffffffffff'], ['255', '10'])

controller.table_add('ndp_reply_table','ndp_ns_to_na', ['2001:c:1::ff'], ['00:aa:00:00:00:01'])
controller.table_add('ndp_reply_table','ndp_ns_to_na', ['3:101:c::ff'], ['00:aa:00:00:00:01'])
